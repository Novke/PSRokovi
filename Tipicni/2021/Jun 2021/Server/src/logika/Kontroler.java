...
public class Kontroler {
    ...
    public ArrayList<VrstaNepokretnosti> vratiNepokretnosti() {
        return dbb.vratiNepokretnosti();
    }

    public boolean sacuvajPrijave(ArrayList<PoreskaPrijava> prijave) {
        try {
            return dbb.sacuvajPrijave(prijave);
    ...
    public ArrayList<PoreskiObveznik> vratiObveznike(String dodatniUpit) {
        return dbb.vratiObveznike(dodatniUpit);
    }

    public ArrayList<PoreskaPrijava> vratiPrijaveObveznika(PoreskiObveznik po) {
        return dbb.vratiPrijaveObveznika(po);
    }
