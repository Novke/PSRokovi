        ...
        while(true){
            ...
            switch(kz.getOperacija()){
                ...
                case Operacije.VRATI_IZDAVACE:
                    ...
                    break;
                case Operacije.GENERISI_ID_IGRE:
                    int igraID = Kontroler.getInstance().vratiIgruID();
                    so.setOdgovor(igraID);
                    break;
                case Operacije.SACUVAJ_IGRU:
                    Igra i = (Igra) kz.getParametar();
                    boolean uspesno = Kontroler.getInstance().sacuvajIgru(i);
