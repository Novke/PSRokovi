        ...
        while(true){
            ...
            switch(kz.getOperacija()){
                case Operacije.LOGIN:
                    ...
                    Proizvodjac p = Kontroler.getInstance().login(username, password);
                    so.setOdgovor(p);
                    break;
                case Operacije.SACUVAJ_DNEVNI_IZVESTAJ:
                    DnevnaProizvodnjaIzvestaj dpi = (DnevnaProizvodnjaIzvestaj) kz.getParametar();
                    boolean uspesno = Kontroler.getInstance().sacuvajDnevniIzvestaj(dpi);
